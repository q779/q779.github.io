(function() {
    ...
    if (e || "undefined" == typeof window || (e = window),
    "undefined" == typeof requirejs) {
        ...
        (t = "") && (e[t] || (e[t] = {}),
        i = e[t]),
        i.define && i.define.packaged || (o.original = i.define,
        i.define = o,
        i.define.packaged = !0),
        i.require && i.require.packaged || (l.original = i.require,
        i.require = l,
            ...
            if (!a && 1 < s.length && -1 < function(e, t, i) {
                ...
                for (var n = i || 0; n < e.length; n++)
                    if (e[n] === t)
                        return n;
                return -1
            }(s, "") && (i = RegExp(this.source, r.replace.call(((n = this).global ? "g" : "") + (n.ignoreCase ? "i" : "") + (n.multiline ? "m" : "") + (n.extended ? "x" : "") + (n.sticky ? "y" : ""), "g", "")),
...
define("ace/lib/es5-shim", ["require", "exports", "module"], function(e, t, i) {
    ...
    function s(e) {
        return (e = +e) != e ? e = 0 : 0 !== e && e !== 1 / 0 && e !== -1 / 0 && (e = (0 < e || -1) * Math.floor(Math.abs(e))),
        e
    }
    Function.prototype.bind || (Function.prototype.bind = function(t) {
        ...
        return i.prototype && (o.prototype = i.prototype,
        s.prototype = new o,
        o.prototype = null),
        s
    }
    );
    var r, a, l, h, c, u, d, g = Function.prototype.call, f = Array.prototype, m = Object.prototype, p = f.slice, v = g.bind(m.toString), w = g.bind(m.hasOwnProperty);
    if ((c = w(m, "__defineGetter__")) && (r = g.bind(m.__defineGetter__),
    a = g.bind(m.__defineSetter__),
    l = g.bind(m.__lookupGetter__),
    h = g.bind(m.__lookupSetter__)),
    2 != [1, 2].splice(0).length)
        if ((d = []).splice.apply(d, b(20)),
        d.splice.apply(d, b(26)),
        u = d.length,
        d.splice(5, 0, "XXX"),
        d.length,
        u + 1 != d.length)
            Array.prototype.splice = function(e, t) {
                var i = this.length;
                0 < e ? i < e && (e = i) : null == e ? e = 0 : e < 0 && (e = Math.max(i + e, 0)),
                e + t < i || (t = i - e);
    ...
    var y, S = Object("a"), C = "a" != S[0] || !(0 in S);
    ...
    Array.prototype.filter || (Array.prototype.filter = function(e) {
        var t, i = F(this), n = C && "[object String]" == v(this) ? this.split("") : i, s = n.length >>> 0, o = [], r = arguments[1];
        if ("[object Function]" != v(e))
            throw new TypeError(e + " is not a function");
        for (var a = 0; a < s; a++)
            a in n && (t = n[a],
    ...
    Array.prototype.reduceRight || (Array.prototype.reduceRight = function(e) {
        ...
        for (; o in this && (s = e.call(void 0, s, i[o], o, t)),
        o--; )
            ;
        return s
    }
    ...
    Array.prototype.indexOf && -1 == [0, 1].indexOf(1, 2) || (Array.prototype.indexOf = function(e) {
        ...
        if (!i)
            return -1;
        var n = 0;
        for (1 < arguments.length && (n = s(arguments[1])),
        n = 0 <= n ? n : Math.max(0, i + n); n < i; n++)
            if (n in t && t[n] === e)
                return n;
        return -1
    }
    ...
    Array.prototype.lastIndexOf && -1 == [0, 1].lastIndexOf(0, -3) || (Array.prototype.lastIndexOf = function(e) {
        ...
        if (!i)
            return -1;
        var n = i - 1;
        for (1 < arguments.length && (n = Math.min(n, s(arguments[1]))),
    ...
    Object.defineProperties || (Object.defineProperties = function(e, t) {
        for (var i in t)
            w(t, i) && Object.defineProperty(e, i, t[i]);
        return e
    }
    ),
...
define("ace/lib/dom", ["require", "exports", "module", "ace/lib/useragent"], function(e, a, t) {
    ...
    a.HI_DPI = !i.isWin || "undefined" != typeof window && 1.5 <= window.devicePixelRatio,
    "undefined" != typeof document) {
        var n = document.createElement("div");
        a.HI_DPI && void 0 !== n.style.transform && (a.HAS_CSS_TRANSFORMS = !0),
        i.isEdge || void 0 === n.style.animationName || (a.HAS_CSS_ANIMATION = !0),
        n = null
    }
...
define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent"], function(e, u, t) {
    ...
    u.capture = function(e, t, i) {
        function n(e) {
            t && t(e),
            i && i(e),
            f(document, "mousemove", t),
            f(document, "mouseup", n),
            f(document, "dragstart", n)
        }
        return g(document, "mousemove", t),
        g(document, "mouseup", n),
        g(document, "dragstart", n),
        n
    }
    ,
...
define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang", "ace/clipboard", "ace/lib/keys"], function(e, t, i) {
    ...
    t.TextInput = function(e, u) {
        ...
        D.addListener(d, "focus", function(e) {
            if (!t) {
                if (b = !0,
                B.isEdge)
                    try {
        ...
        var y = j ? function(e) {
            if (b && (!r || e) && !f) {
                ...
                4 == v && w == i || d.setSelectionRange(4, i),
                v = 4,
                w = i
            }
        }
        : function() {
            if (!h && !f && (b || A)) {
                ...
                if (u.session) {
                    ...
                    if (e = s.start.column,
                    t = s.end.column,
                    i = u.session.getLine(o),
                    s.start.row != o) {
                        var r = u.session.getLine(o - 1);
                        e = s.start.row < o - 1 ? 0 : e,
                        t += r.length + 1,
                        i = r + "\n" + i
                    } else if (s.end.row != o) {
                        var a = u.session.getLine(o + 1);
                        t = s.end.row > o + 1 ? a.length : t,
                        t += i.length + 1,
                        i = i + "\n" + a
                    } else
                        X && 0 < o && (i = "\n" + i,
                ...
                if (l != p && (d.value = p = l,
                v = w = l.length),
                A && (v = d.selectionStart,
                w = d.selectionEnd),
                w != t || v != e || d.selectionEnd != w)
                    try {
                        d.setSelectionRange(e, t),
                        v = e,
                        w = t
                    } catch (e) {}
                h = !1
        ...
        function s(e, t) {
            ...
            g)
                ...
                g = !1,
                "";
            for (var i = d.selectionStart, n = d.selectionEnd, s = v, o = p.length - w, r = e, a = e.length - i, l = e.length - n, h = 0; 0 < s && p[h] == e[h]; )
                h++,
                s--;
            for (r = r.slice(h),
            h = 1; 0 < o && p.length - h > v - 1 && p[p.length - h] == e[e.length - h]; )
                h++,
                o--;
            a -= h - 1,
            l -= h - 1;
            ...
            r = r.slice(0, c),
            t || r || a || s || o || l ? (f = !0,
            r && !s && !o && !a && !l || m ? u.onTextInput(r) : u.onTextInput(r, {
                extendLeft: s,
                extendRight: o,
                restoreStart: a,
                restoreEnd: l
        ...
        function x(e) {
            var t = k(e);
            N.pasteCancelled() || ("string" == typeof t ? (t && u.onPaste(t, e),
            B.isIE && setTimeout(y),
            D.preventDefault(e)) : (d.value = "",
            g = !0))
        }
        ...
        D.addCommandKeyListener(d, u.onCommandKey.bind(u), u),
        D.addListener(d, "select", function(e) {
            var t;
            h || (r ? r = !1 : 0 === (t = d).selectionStart && t.selectionEnd >= p.length && t.value === p && p && t.selectionEnd !== w ? (u.selectAll(),
            y()) : X && d.selectionStart != v && y())
        }, u),
        D.addListener(d, "input", o, u),
        D.addListener(d, "cut", S, u),
        D.addListener(d, "copy", C, u),
        D.addListener(d, "paste", x, u),
        "oncut"in d && "oncopy"in d && "onpaste"in d || D.addListener(e, "keydown", function(e) {
        ...
        var L = function() {
            if (h && u.onCompositionUpdate && !u.$readOnly) {
                ...
                if (h.useTextareaForIME)
                    ...
                    h.markerRange.end.column = h.markerRange.start.column + w - h.selectionStart + $)
                }
            }
        }
          , R = function(e) {
            u.onCompositionEnd && !u.$readOnly && (h = !1,
            u.onCompositionEnd(),
            u.off("mousedown", i),
            e && o())
        }
        ...
        D.addListener(d, "compositionstart", function(e) {
            if (!h && u.onCompositionStart && !u.$readOnly && (h = {},
            !m)) {
                e.data && (h.useTextareaForIME = !1),
                setTimeout(L, 0),
                ...
                h.markerRange = t,
                h.selectionStart = v,
                u.onCompositionStart(h),
                h.useTextareaForIME ? (p = d.value = "",
                w = v = 0) : (d.msGetInputContext && (h.context = d.msGetInputContext()),
                d.getInputContext && (h.context = d.getInputContext()))
            }
        }, u),
        D.addListener(d, "compositionupdate", L, u),
        D.addListener(d, "keyup", function(e) {
            27 == e.keyCode && d.value.length < d.selectionStart && (h || (p = d.value),
            v = w = -1,
            y()),
            E()
        }, u),
        D.addListener(d, "keydown", E, u),
        D.addListener(d, "compositionend", R, u),
        ...
        this.moveToMouse = function(e, t) {
            c = c || d.style.cssText,
            d.style.cssText = (t ? "z-index:100000;" : "") + (B.isIE ? "opacity:0.1;" : "") + "text-indent: -" + (v + w) * u.renderer.characterWidth * .5 + "px;";
            function i(e) {
            ...
            i(e),
            "mousedown" == e.type && (u.renderer.$isMousePressed = !0,
            clearTimeout(_),
            B.isWin && D.capture(u.container, i, l))
        }
        ,
        this.onContextMenuClose = l;
        function M(e) {
            u.textInput.onContextMenu(e),
            l()
        }
        var _, T, O, F, I;
        function W(e) {
            if (document.activeElement === O && !(I || h || T.$mouseHandler.isMousePressed || r)) {
                var t = O.selectionStart
                  ...
                  , n = null
                  , s = 0;
                if (0 == t ? n = K.up : 1 == t ? n = K.home : w < i && "\n" == p[i] ? n = K.end : t < v && " " == p[t - 1] ? (n = K.left,
                s = G.option) : t < v || t == v && w != v && t == i ? n = K.left : w < i && 2 < p.slice(0, i).split("\n").length ? n = K.down : w < i && " " == p[i - 1] ? (n = K.right,
                s = G.option) : (w < i || i == w && w != v && t == i) && (n = K.right),
                t !== i && (s |= G.shift),
                n) {
        ...
        D.addListener(d, "mouseup", M, u),
        D.addListener(d, "mousedown", function(e) {
            e.preventDefault(),
            l()
        }, u),
        D.addListener(u.renderer.scroller, "contextmenu", M, u),
        D.addListener(d, "contextmenu", M, u),
        j && (T = u,
        F = null,
        I = !1,
        (O = d).addEventListener("keydown", function(e) {
            F && clearTimeout(F),
            I = !0
        }, !0),
    ...
    (function() {
        ...
        this.onMouseWheel = function(e) {
            if (!e.getAccelKey()) {
                ...
                var a = Math.abs(o / r)
                  , l = !1;
                if (1 <= a && t.renderer.isScrollableBy(e.wheelX * e.speed, 0) && (l = !0),
                a <= 1 && t.renderer.isScrollableBy(0, e.wheelY * e.speed) && (l = !0),
                l)
                    i.allowed = n;
                else if (n - i.allowed < 550) {
                    Math.abs(o) <= 1.5 * Math.abs(i.vx) && Math.abs(r) <= 1.5 * Math.abs(i.vy) ? (l = !0,
...
define("ace/mouse/dragdrop_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent"], function(e, t, i) {
    ...
    function n(t) {
        function e() {
            ...
            !w || n || s ? (g.moveCursorToPosition(e),
            w = i,
            $ = {
                x: f,
                y: m
            }) : 5 < C($.x, $.y, f, m) ? w = null : 200 <= i - w && (g.renderer.scrollCursorIntoView(),
            w = null),
            function(e, t) {
                var i = Date.now()
        ...
        k.isOpera && (a.style.cssText = "width:1px;height:1px;position:fixed;top:0;left:0;z-index:2147483647;opacity:0;");
        ["dragWait", "dragWaitEnd", "startDrag", "dragReadyEnd", "onMouseDrag"].forEach(function(e) {
            t[e] = this[e]
        }, this),
        g.on("mousedown", this.onMouseDown.bind(t));
        var l, f, m, h, c, u, d, p, v, w, $, b = g.container, y = 0;
        this.onDragStart = function(e) {
            ...
            k.isOpera && (g.container.appendChild(a),
            a.scrollTop = 0),
        ...
        ,
        A.addListener(b, "dragstart", this.onDragStart.bind(t), g),
        A.addListener(b, "dragend", this.onDragEnd.bind(t), g),
        A.addListener(b, "dragenter", this.onDragEnter.bind(t), g),
        A.addListener(b, "dragover", this.onDragOver.bind(t), g),
        A.addListener(b, "dragleave", this.onDragLeave.bind(t), g),
        A.addListener(b, "drop", this.onDrop.bind(t), g);
        var S = null
    }
    function C(e, t, i, n) {
    ...
    (function() {
        ...
        this.onMouseDrag = function(e) {
            ...
            "dragWait" === this.state && 0 < C(this.mousedownEvent.x, this.mousedownEvent.y, this.x, this.y) && (t.draggable = !1,
            this.startSelect(this.mousedownEvent.getDocumentPosition()))
        }
        ,
        this.onMouseDown = function(e) {
            if (this.$dragEnabled) {
                ...
                if (1 === (e.domEvent.detail || 1) && 0 === n && i) {
                    ...
                    if ("unselectable"in s && (s.unselectable = "on"),
                    t.getDragDelay()) {
                        if (k.isWebKit)
                            this.cancelDrag = !0,
...
define("ace/mouse/touch_handler", ["require", "exports", "module", "ace/mouse/mouse_event", "ace/lib/event", "ace/lib/dom"], function(e, t, i) {
    ...
    t.addTouchListeners = function(e, v) {
        function n() {
            function t(e) {
                ...
                if ("more" == n || !o)
                    return o = !o,
                    t = v.getCopyText(),
                    i = v.session.getUndoManager().hasUndo(),
                    void r.replaceChild(a.buildDom(o ? ["span", !t && ["span", {
                    ...
                    }, "Pallete"]] : ["span"]), r.firstChild);
                "paste" == n ? s.readText().then(function(e) {
                    v.execCommand(n, e)
                }) : n && ("cut" != n && "copy" != n || (s ? s.writeText(v.getCopyText()) : document.execCommand("copy")),
                v.execCommand(n)),
                r.firstChild.style.display = "none",
                o = !1,
                "openCommandPallete" != n && v.focus()
            }
        ...
        function i() {
            ...
            r.style.top = t.pageY - i.top - 3 + "px",
            r.style.right = "10px",
            r.style.display = "",
            r.firstChild.style.display = "none",
            v.on("input", s)
        ...
        function w() {
            ...
            !e.isEmpty() && t || (v.selection.moveToPosition(x),
            v.selection.selectWord()),
            k = "wait",
            i()
        }
        var $, b, y, S, C, t, x, A, r, k = "scroll", L = 0, R = 0, E = 0, M = 0;
        o.addListener(e, "contextmenu", function(e) {
            A && v.textInput.getElement().focus()
        }, v),
        o.addListener(e, "touchstart", function(e) {
            var t = e.touches;
            if (C || 1 < t.length)
            ...
            var o = t[0]
              , r = o.clientX
              , a = o.clientY;
            Math.abs($ - r) + Math.abs(b - a) > i && (y = -1),
            $ = e.clientX = r,
            b = e.clientY = a,
            E = M = 0;
            var l = new _(e,v);
            if (x = l.getDocumentPosition(),
            s - y < 500 && 1 == t.length && !L)
                R++,
                e.preventDefault(),
                e.button = 0,
                function() {
                    C = null,
                    clearTimeout(C),
                    v.selection.moveToPosition(x);
                    var e = 2 <= R ? v.selection.getLineRange(x.row) : v.session.getBracketRange(x);
                    e && !e.isEmpty() ? v.selection.setRange(e) : v.selection.selectWord(),
                    k = "wait"
                }();
            else {
                R = 0;
                ...
                m < 3.5 && p < 3.5 && (k = p < m ? "cursor" : "anchor"),
                k = p < 3.5 ? "anchor" : m < 3.5 ? "cursor" : "scroll",
                C = setTimeout(w, 450)
            }
            y = s
        }, v),
        o.addListener(e, "touchend", function(e) {
            A = v.$mouseHandler.isMousePressed = !1,
            t && clearInterval(t),
            "zoom" == k ? (k = "",
            L = 0) : C ? (v.selection.moveToPosition(x),
            L = 0,
            i()) : "scroll" == k ? (L += 60,
            t = setInterval(function() {
                ...
                v.renderer.scrollBy(10 * E, 10 * M),
                e == v.session.getScrollTop() && (L = 0)
            }, 10),
            s()) : i(),
            clearTimeout(C),
            C = null
        }, v),
        o.addListener(e, "touchmove", function(e) {
            C && (clearTimeout(C),
            C = null);
            var t = e.touches;
            if (!(1 < t.length || "zoom" == k)) {
                ...
                "scroll" == k) {
                    ...
                    0 != r && (E = n / r,
                    M = s / r),
                    v._emit("mousewheel", a),
                    a.propagationStopped || (E = M = 0)
                } else {
                    var l = new _(e,v).getDocumentPosition();
                    "cursor" == k ? v.selection.moveCursorToPosition(l) : "anchor" == k && v.selection.setSelectionAnchor(l.row, l.column),
                    v.renderer.scrollCursorIntoView(l),
                    e.preventDefault()
                }
            }
        }, v)
...
define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/app_config"], function(f, m, p) {
    ...
    m.moduleUrl = function(e, t) {
        ...
        var r = w[t + "Path"];
        return null == r ? r = w.basePath : "/" == n && (t = n = ""),
        r && "/" != r.slice(-1) && (r += "/"),
    ...
    ;
    var r = function() {
        w.basePath || w.workerPath || w.modePath || w.themePath || Object.keys(w.$moduleUrls).length || (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"),
        r = function() {}
        )
    };
    m.init = function(e) {
    ...
    t.FoldHandler = function(r) {
        ...
        r.on("gutterclick", function(e) {
            if ("foldWidgets" == r.renderer.$gutterLayer.getRegion(e)) {
                var t = e.getDocumentPosition().row
                  , i = r.session;
                i.foldWidgets && i.foldWidgets[t] && r.session.onFoldWidgetClick(t, e),
                r.isFocused() || r.focus(),
                e.stop()
            }
        }),
...
define("ace/lib/bidiutil", ["require", "exports", "module"], function(e, l, t) {
    ...
    function m(e, t, i, n) {
        ...
        case R:
            return x;
        case E:
            return n < 1 || n + 1 >= t.length || (s = i[n - 1]) != g && s != f || (o = t[n + 1]) != g && o != f ? x : ($ && (o = f),
            o == s ? o : x);
        case M:
    ...
    var v = 0
      ...
      , b = !1
      , y = !1
      , S = [[0, 3, 0, 1, 0, 0, 0], [0, 3, 0, 1, 2, 2, 0], [0, 3, 0, 17, 2, 0, 1], [0, 3, 5, 5, 4, 1, 0], [0, 3, 21, 21, 4, 0, 1], [0, 3, 5, 5, 4, 2, 0]]
    ...
    l.doBidiReorder = function(e, t, i) {
        ...
        for (a = 0; a < s.length - 1; a++)
            t[a] === f ? r[a] = l.AN : r[a] === d && (t[a] > L && t[a] < O || t[a] === x || t[a] === B) ? r[a] = l.ON_R : 0 < a && "ل" === n[a - 1] && /\u0622|\u0623|\u0625|\u0627/.test(n[a]) && (r[a - 1] = r[a] = l.R_H,
            a++);
    ...
    (function() {
        ...
        this.updateRowLine = function(e, t) {
            ...
            this.session.$useWrapMode) {
                ...
                0 < t && n.length ? (this.wrapIndent = n.indent,
                this.wrapOffset = this.wrapIndent * this.charWidths[a.L],
                this.line = t < n.length ? this.line.substring(n[t - 1], n[t]) : this.line.substring(n[n.length - 1])) : this.line = this.line.substring(0, n[t])),
                t == n.length && (this.line += this.showInvisibles ? i : a.DOT)
            } else
...
define("ace/selection", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/range"], function(e, t, i) {
    ...
    (function() {
        ...
        this.getLineRange = function(e, t) {
            ...
            return i = s ? (n = s.start.row,
            s.end.row) : n,
            !0 === t ? new a(n,0,i,this.session.getLine(i).length) : new a(n,0,i + 1,0)
        }
        ,
        ...
        this.moveCursorBy = function(e, t) {
            ...
            if (0 === t && (0 !== e && (this.session.$bidiHandler.isBidiRow(n.row, this.lead.row) ? (i = this.session.$bidiHandler.getPosLeft(n.column),
        ...
        this.states) {
            for (var i = this.states[t], n = [], s = 0, o = this.matchMappings[t] = {
                ...
                null != h.regex) {
                    ...
                    h.token = null,
                    h.onMatch = this.$arrayTokens) : "function" != typeof h.token || h.onMatch || (h.onMatch = 1 < u ? this.$applyToken : h.token),
                    1 < u && (c = /\\\d/.test(h.regex) ? h.regex.replace(/\\([0-9]+)/g, function(e, t) {
                        return "\\" + (parseInt(t, 10) + s + 1)
                    }) : (u = 1,
                    this.removeCapturingGroups(h.regex)),
        ...
        this.getLineTokens = function(e, t) {
            ...
            for (var o, r = this.matchMappings[n], a = this.regExps[n], l = [], h = a.lastIndex = 0, c = 0, u = {
                ...
                if (m - f.length > h) {
                    ...
                    u.type == d ? u.value += p : (u.type && l.push(u),
                    u = {
                        type: d,
                        value: p
                    })
                ...
                for (var v = 0; v < o.length - 2; v++)
                    if (void 0 !== o[v + 1]) {
                        d = (g = s[r[v]]).onMatch ? g.onMatch(f, n, i, e) : g.token,
                ...
                if (f)
                    if ("string" == typeof d)
                        g && !1 === g.merge || u.type !== d ? (u.type && l.push(u),
                        u = {
                            type: d,
                            value: f
                        }) : u.value += f;
            ...
            Object.keys(d).forEach(function e(t) {
                ...
                for (var n = 0; n < i.length; n++) {
                    ...
                    if (r && Array.isArray(r)) {
                        var a = s.stateName;
                        a || ("string" != typeof (a = s.token) && (a = a[0] || ""),
                        d[a] && (a += u++)),
                        d[a] = r,
                        e(s.next = a)
                    } else
                        "pop" == r && (s.next = f);
                    if (s.push && (s.nextState = s.next || s.push,
                    s.next = g,
                    delete s.push),
                    s.rules)
...
define("ace/mode/behaviour/cstyle", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/token_iterator", "ace/lib/lang"], function(e, t, i) {
    ...
    var f, n = e("../../lib/oop"), s = e("../behaviour").Behaviour, o = e("../../token_iterator").TokenIterator, m = e("../../lib/lang"), r = ["text", "paren.rparen", "rparen", "paren", "punctuation.operator"], a = ["text", "paren.rparen", "rparen", "paren", "punctuation.operator", "comment"], l = {}, x = {
        ...
        this.add("string_dquotes", "deletion", function(e, t, i, n, s) {
            ...
            if (!s.isMultiLine() && o.hasOwnProperty(r) && (S(i),
...
define("ace/mode/text", ["require", "exports", "module", "ace/config", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/behaviour/cstyle", "ace/unicode", "ace/lib/lang", "ace/token_iterator", "ace/range"], function(e, t, i) {
    ...
    (function() {
        ...
        this.toggleCommentLines = function(e, s, i, n) {
            ...
            if (this.lineCommentStart) {
                if (Array.isArray(this.lineCommentStart))
                    m = this.lineCommentStart.map(y.escapeRegExp).join("|"),
                    g = this.lineCommentStart[0];
                else
                    m = y.escapeRegExp(this.lineCommentStart),
                ...
                var g = this.blockComment.start
                  ...
                  , w = function(e, t) {
                    var i;
                    (i = e.match(p)) && o.removeInLine(t, e.length - i[0].length, e.length),
            ...
            t(function(e, t) {
                var i = e.search(/\S/);
                -1 !== i ? (i < l && (l = i),
                a && !$(e, t) && (a = !1)) : b > e.length && (b = e.length)
            }),
            l == 1 / 0 && (l = b,
            a = r = !1),
        ...
        this.toggleBlockComment = function(e, t, i, n) {
            ...
            if (s) {
                !s.start && s[0] && (s = s[0]);
                var o, r, a = (g = new m(t,n.row,n.column)).getCurrentToken(), l = (t.selection,
    ...
    (function() {
        ...
        this.$updateOnChange = function(e) {
            ...
            if (0 == i)
                ...
                this.lines.splice(t, 1 + i, null),
                this.states.splice(t, 1 + i, null);
            else {
                var n = Array(1 + i);
                n.unshift(t, 1),
...
define("ace/edit_session/folding", ["require", "exports", "module", "ace/range", "ace/edit_session/fold_line", "ace/edit_session/fold", "ace/token_iterator"], function(e, t, i) {
    ...
    t.Folding = function() {
        ...
        this.unfold = function(e, t) {
            ...
            t = !0) : i = "number" == typeof e ? new c(e,0,e,this.getLine(e).length) : "row"in e ? c.fromPoints(e, e) : e,
...
define("ace/edit_session/bracket_match", ["require", "exports", "module", "ace/token_iterator", "ace/range"], function(e, t, i) {
    ...
    t.BracketMatch = function() {
        ...
        this.getBracketRange = function(e) {
            var t, i = this.getLine(e.row), n = !0, s = i.charAt(e.column - 1), o = s && s.match(/([\(\[\{])|([\)\]\}])/);
            if (o || (s = i.charAt(e.column),
            e = {
                row: e.row,
                column: e.column + 1
            },
    ...
    function() {
        ...
        this.getWordRange = function(e, t) {
            var i = this.getLine(e)
              , n = !1;
            if (0 < t && (n = !!i.charAt(t - 1).match(this.tokenRe)),
        ...
        this.moveText = function(e, t, i) {
            ...
            if (!i) {
                ...
                (h = r ? -e.end.column : e.start.column - e.end.column) && (o.start.row == e.end.row && o.start.column > e.end.column && (o.start.column += h),
                o.end.row == e.end.row && o.end.column > e.end.column && (o.end.column += h)),
                r && o.start.row >= e.end.row && (o.start.row += r,
                o.end.row += r)
            }
            ...
            s.length) {
                ...
                this.addFolds(s.map(function(e) {
                    return (e = e.clone()).start.row == a.row && (e.start.column += h),
        ...
        this.screenToDocumentPosition = function(e, t, i) {
            ...
            if (u && 0 <= c) {
                ...
                d = !u;
            for (var g = this.getLength() - 1, f = this.getNextFoldLine(o), m = f ? f.start.row : 1 / 0; a <= e && !(e < a + (l = this.getRowLength(o)) || g <= o); )
                a += l,
                m < ++o && (o = f.end.row + 1,
        ...
        this.documentToScreenPosition = function(e, t) {
            ...
            var f = "";
            o = d && g <= a ? (f = this.getFoldDisplayLine(d, e, t),
        ...
        this.getScreenLength = function() {
            var e = 0
              , t = null;
            if (this.$useWrapMode)
                for (var i = this.$wrapData.length, n = 0, s = (a = 0,
                (t = this.$foldData[a++]) ? t.start.row : 1 / 0); n < i; ) {
        ...
        this.findAll = function(e) {
            ...
            if (i) {
                var w = i.start.column
                  , $ = i.start.column;
                for (m = 0,
                c = s.length - 1; m < c && s[m].start.column < w && s[m].start.row == i.start.row; )
                    m++;
...
define("ace/editor", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/lib/useragent", "ace/keyboard/textinput", "ace/mouse/mouse_handler", "ace/mouse/fold_handler", "ace/keyboard/keybinding", "ace/edit_session", "ace/search", "ace/range", "ace/lib/event_emitter", "ace/commands/command_manager", "ace/commands/default_commands", "ace/config", "ace/token_iterator", "ace/clipboard"], function(e, t, i) {
    ...
    function() {
            ...
            if (!this.$highlightPending) {
                ...
                setTimeout(function() {
                    ...
                    if (t && t.bgTokenizer) {
                        ...
                        if (!e && t.$mode.getMatching && (e = t.$mode.getMatching(n.session)),
                        e) {
                            var i = "ace_bracket";
                            Array.isArray(e) ? 1 == e.length && (i = "ace_error_bracket") : e = [e],
                            2 == e.length && (0 == m.comparePoints(e[0].end, e[1].start) ? e = [m.fromPoints(e[0].start, e[1].end)] : 0 == m.comparePoints(e[0].start, e[1].end) && (e = [m.fromPoints(e[1].start, e[0].end)])),
                            t.$bracketHighlight = {
                                ranges: e,
                ...
                setTimeout(function() {
                    ...
                    if (e && e.bgTokenizer) {
                        ...
                        if (-1 == n.type.indexOf("tag-open") || (n = i.stepForward())) {
                            ...
                            if ("<" == r.value)
                                for (; r = n,
                                (n = i.stepForward()) && n.value === s && -1 !== n.type.indexOf("tag-name") && ("<" === r.value ? o++ : "</" === r.value && o--),
                                n && 0 <= o; )
                                    ;
                            else {
                                for (; n = r,
                                r = i.stepBackward(),
                                n && n.value === s && -1 !== n.type.indexOf("tag-name") && ("<" === r.value ? o++ : "</" === r.value && o--),
                                r && o <= 0; )
                                    ;
                                i.stepForward()
                            }
                            ...
                            e.$tagHighlight && null != c && 0 !== h.compareRange(c.range) && (e.removeMarker(e.$tagHighlight),
                            e.$tagHighlight = null),
                            e.$tagHighlight || (e.$tagHighlight = e.addMarker(h, "ace_bracket", "text"))
                        }
                    }
                }, 50)
            }
        ...
        this.insert = function(e, t) {
            ...
            this.selection.isEmpty()) {
                if (this.session.getOverwrite() && -1 == e.indexOf("\n")) {
                    (r = new m.fromPoints(s,s)).end.column += e.length,
            ...
            var h = s.column
              , c = i.getState(s.row)
              , u = (a = i.getLine(s.row),
            n.checkOutdent(c, a, e));
            if (i.insert(s, e),
            o && o.selection && (2 == o.selection.length ? this.selection.setSelectionRange(new m(s.row,h + o.selection[0],s.row,h + o.selection[1])) : this.selection.setSelectionRange(new m(s.row + o.selection[0],o.selection[1],s.row + o.selection[2],o.selection[3]))),
        ...
        this.autoIndent = function() {
            var e, t, i = this.session, n = i.getMode();
            ...
            for (var o, r, a, l = "", h = "", c = "", u = i.getTabString(), d = e; d <= t; d++)
                0 < d && (l = i.getState(d - 1),
                h = i.getLine(d - 1),
                c = n.getNextLineIndent(l, h, u)),
                o = i.getLine(d),
                c !== (r = n.$getIndent(o)) && (0 < r.length && (a = new m(d,0,d,r.length),
                i.remove(a)),
                0 < c.length && i.insert({
                    row: d,
                    column: 0
        ...
        this.transposeLetters = function() {
            if (this.selection.isEmpty()) {
                ...
                if (0 !== t) {
                    ...
                    n = t < s.length ? (i = s.charAt(t) + s.charAt(t - 1),
                    new m(e.row,t - 1,e.row,t + 1)) : (i = s.charAt(t - 1) + s.charAt(t - 2),
        ...
        this.toggleWord = function() {
            ...
            for (var h, c = this.$toggleWordPairs, u = 0; u < c.length; u++)
                for (var d = c[u], g = 0; g <= 1; g++) {
                    ...
                    if (m)
                        n.match(new RegExp("([_]|^|\\s)(" + p.escapeRegExp(m[1]) + ")($|\\s)","g")) && (h = n.replace(new RegExp(p.escapeRegExp(d[g]),"i"), function(e) {
                            var t = d[f];
        ...
        this.jumpToMatching = function(e, t) {
            ...
            if (o) {
                ...
                if (r) {
                    var d, g;
                    if ("bracket" === r)
                        (d = this.session.getBracketRange(i)) || (g = (d = new m(n.getCurrentTokenRow(),n.getCurrentTokenColumn() + c - 1,n.getCurrentTokenRow(),n.getCurrentTokenColumn() + c - 1)).start,
                        (t || g.row === i.row && Math.abs(g.column - i.column) < 2) && (d = this.session.getBracketRange(g)));
                    else if ("tag" === r) {
                        ...
                        if (0 === (d = new m(n.getCurrentTokenRow(),n.getCurrentTokenColumn() - 2,n.getCurrentTokenRow(),n.getCurrentTokenColumn() - 2)).compare(i.row, i.column))
                            ...
                            o.value === f && -1 !== o.type.indexOf("tag-name") && ("<" === s.value ? h[f]++ : "</" === s.value && h[f]--,
                            0 === h[f] && (l = !0))),
                            s && !l; )
                                ;
    ...
    function l(e, t) {
        ...
        if (i && n)
            ...
            if (0 <= m(t.start, e.end))
                ...
                var s, o;
                if (!(m(t.end, e.start) <= 0))
                    return m(e.start, t.start) < 0 && (e = u(s = e, t.start)),
                    0 < m(e.end, t.end) && (o = u(e, t.end)),
...
define("ace/layer/gutter", ["require", "exports", "module", "ace/lib/dom", "ace/lib/oop", "ace/lib/lang", "ace/lib/event_emitter", "ace/layer/lines"], function(e, t, i) {
    ...
    function n(e) {
        this.element = w.createElement("div"),
    ...
    (function() {
        ...
        this.$renderCell = function(e, t, i, n) {
            var s = e.element
              ...
              , f = "ace_gutter-cell ";
            if (this.$highlightGutterLine && (n == this.$cursorRow || i && n < this.$cursorRow && g <= n && this.$cursorRow <= i.end.row) && (f += "ace_gutter-active-line ",
            ...
            h[n] && (f += h[n]),
            c[n] && (f += c[n]),
            this.$annotations[n] && (f += this.$annotations[n].className),
            s.className != f && (s.className = f),
            d) {
                var m = d[n];
            ...
            if (m) {
                ...
                "start" == m && n == g && n < i.end.row ? f += " ace_closed" : f += " ace_open",
                a.className != f && (a.className = f);
                var p = t.lineHeight + "px";
                w.setStyle(a.style, "height", p),
                w.setStyle(a.style, "display", "inline-block")
            } else
                a && w.setStyle(a.style, "display", "none");
            var v = (u ? u.getText(o, n) : n + l).toString();
            return v !== r.data && (r.data = v),
            w.setStyle(e.element.style, "height", this.$lines.computeLineHeight(n, t, o) + "px"),
            w.setStyle(e.element.style, "top", this.$lines.computeLineTop(n, t, o) + "px"),
            e.text = v,
            e
        }
        ,
        ...
        this.setShowFoldWidgets = function(e) {
            e ? w.addCssClass(this.element, "ace_folding-enabled") : w.removeCssClass(this.element, "ace_folding-enabled"),
...
define("ace/layer/text", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/lang", "ace/layer/lines", "ace/lib/event_emitter"], function(e, t, i) {
    ...
    (function() {
        ...
        this.onChangeTabSize = this.$computeTabString = function() {
            ...
            for (var t = this.$tabStrings = [0], i = 1; i < e + 1; i++)
                if (this.showTabs) {
                    ...
                    n.textContent = w.stringRepeat(this.TAB_CHAR, i),
                    t.push(n)
                } else
                    t.push(this.dom.createTextNode(w.stringRepeat(" ", i), this.element));
            if (this.displayIndentGuides) {
                ...
                n.textContent = r,
                this.$tabStrings[" "] = n,
                (n = this.dom.createElement("span")).className = s + a,
                n.textContent = l,
                this.$tabStrings["\t"] = n
            }
        }
        ...
        this.updateLines = function(e, t, i) {
            ...
            for (var l, h = !1, c = (a = n,
            (l = this.session.getNextFoldLine(a)) ? l.start.row : 1 / 0); c < a && (a = l.end.row + 1,
        ...
        this.$renderToken = function(e, t, i, n) {
            for (var s, o = this, r = /(\t)|( +)|([\x00-\x1f\x80-\xa0\xad\u1680\u180E\u2000-\u200f\u2028\u2029\u202F\u205F\uFEFF\uFFF9-\uFFFC]+)|(\u3000)|([\u1100-\u115F\u11A3-\u11A7\u11FA-\u11FF\u2329-\u232A\u2E80-\u2E99\u2E9B-\u2EF3\u2F00-\u2FD5\u2FF0-\u2FFB\u3001-\u303E\u3041-\u3096\u3099-\u30FF\u3105-\u312D\u3131-\u318E\u3190-\u31BA\u31C0-\u31E3\u31F0-\u321E\u3220-\u3247\u3250-\u32FE\u3300-\u4DBF\u4E00-\uA48C\uA490-\uA4C6\uA960-\uA97C\uAC00-\uD7A3\uD7B0-\uD7C6\uD7CB-\uD7FB\uF900-\uFAFF\uFE10-\uFE19\uFE30-\uFE52\uFE54-\uFE66\uFE68-\uFE6B\uFF01-\uFF60\uFFE0-\uFFE6]|[\uD800-\uDBFF][\uDC00-\uDFFF])/g, a = this.dom.createFragment(this.element), l = 0; s = r.exec(n); ) {
                ...
                if (o.showSpaces || !c) {
                    ...
                    if (l = s.index + s[0].length,
                    f && a.appendChild(this.dom.createTextNode(f, this.element)),
                    h) {
                        var m = o.session.getScreenTabSize(t + s.index);
                        a.appendChild(o.$tabStrings[m].cloneNode(!0)),
                        t += m - 1
                    } else if (c)
                        if (o.showSpaces) {
                            (v = this.dom.createElement("span")).className = "ace_invisible ace_invisible_space",
                            v.textContent = w.stringRepeat(o.SPACE_CHAR, c.length),
                            a.appendChild(v)
                        } else
                            a.appendChild(this.com.createTextNode(c, this.element));
                    else if (u) {
                        (v = this.dom.createElement("span")).className = "ace_invisible ace_invisible_space ace_invalid",
                        v.textContent = w.stringRepeat(o.SPACE_CHAR, u.length),
                        a.appendChild(v)
                    } else if (d) {
                        t += 1,
                        (v = this.dom.createElement("span")).style.width = 2 * o.config.characterWidth + "px",
                        v.className = o.showSpaces ? "ace_cjk ace_invisible ace_invisible_space" : "ace_cjk",
                        v.textContent = o.showSpaces ? o.SPACE_CHAR : d,
                        a.appendChild(v)
                    } else if (g) {
                        t += 1,
                        (v = this.dom.createElement("span")).style.width = 2 * o.config.characterWidth + "px",
            ...
            if (a.appendChild(this.dom.createTextNode(l ? n.slice(l) : n, this.element)),
            this.$textToken[i.type])
                e.appendChild(a);
            else {
                var p = "ace_" + i.type.replace(/\./g, " ace_")
                  , v = this.dom.createElement("span");
                "fold" == i.type && (v.style.width = i.value.length * this.config.characterWidth + "px"),
                v.className = p,
                v.appendChild(a),
                e.appendChild(v)
            }
            ...
            for (var l = 0; l < t.length; l++) {
                ...
                if (n + c.length < o)
                    ...
                    for (; n + c.length >= o; )
                        ...
                        a = this.$createLineElement(),
                        e.appendChild(a),
                        a.appendChild(this.dom.createTextNode(w.stringRepeat(" ", i.indent), this.element)),
                        r = 0,
        ...
        this.$renderLine = function(e, t, i) {
            ...
            if (n.length) {
                ...
                if (o && o.length) {
                    ...
                    s = e;
                    this.$useLineGroups() && (s = this.$createLineElement(),
                    e.appendChild(s)),
            ...
            return t.walk(function(e, t, i, n, s) {
                ...
                a.length && function(e, t, i) {
                    for (var n = 0, s = 0; s + e[n].value.length < t; )
                        if (s += e[n].value.length,
                        ++n == e.length)
                            return;
                    for (s != t && ((o = e[n].value.substring(t - s)).length > i - t && (o = o.substring(0, i - t)),
                    r.push({
                        type: e[n].type,
                        value: o
                    }),
            ...
            for (var s = t.length; i < s; i++) {
                ...
                if (!((o.top > e.height + e.offset || o.top < 0) && 1 < i)) {
                    var r = this.cursors[n++] || this.addCursor()
                      , a = r.style;
                    this.drawCursor ? this.drawCursor(r, o, e, t[i], this.session) : this.isCursorInView(o, e) ? (h.setStyle(a, "display", "block"),
                    h.translate(r, o.left, o.top),
                    h.setStyle(a, "width", Math.round(e.characterWidth) + "px"),
                    h.setStyle(a, "height", e.lineHeight + "px")) : h.setStyle(a, "display", "none")
                }
            }
    ...
    (function() {
        ...
        this.$updateCachedSize = function(e, t, i, n) {
            ...
            i && (e || o.width != i)) {
                ...
                c.setStyle(this.scrollBarH.element.style, "right", a),
                c.setStyle(this.scroller.style, "right", a),
                c.setStyle(this.scroller.style, "bottom", this.scrollBarH.getHeight()),
                (this.session && this.session.getUseWrapMode() && this.adjustWrapLimit() || e) && (s |= this.CHANGE_FULL)
            }
            return o.$dirty = !i || !n,
                    ...
                    if (i) {
                        ...
                        if (s < 0 || s > n.height - r)
                            ...
                            if (t)
                                ...
                                s += this.lineHeight;
                            (o -= this.scrollLeft) > this.$size.scrollerWidth - a && (o = this.$size.scrollerWidth - a),
                            o += this.gutterWidth + this.margin.left,
                            c.setStyle(e, "height", r + "px"),
                            c.setStyle(e, "width", a + "px"),
                            c.translate(this.textarea, Math.min(o, this.$size.scrollerWidth - a), Math.min(s, l))
                        }
                    }
                } else
        ...
        this.$renderChanges = function(e, t) {
            ...
            this.session && this.container.offsetWidth && !this.$frozen && (e || t)) {
                ...
                if (e & this.CHANGE_FULL || e & this.CHANGE_SIZE || e & this.CHANGE_TEXT || e & this.CHANGE_LINES || e & this.CHANGE_SCROLL || e & this.CHANGE_H_SCROLL) {
                    ...
                    c.translate(this.content, -this.scrollLeft, -i.offset);
                    var s = i.width + 2 * this.$padding + "px"
                      , o = i.minHeight + "px";
                    c.setStyle(this.content.style, "width", s),
                    c.setStyle(this.content.style, "height", o)
                }
                return e & this.CHANGE_H_SCROLL && (c.translate(this.content, -this.scrollLeft, -i.offset),
                ...
                e & this.CHANGE_TEXT || e & this.CHANGE_LINES ? this.$textLayer.update(i) : this.$textLayer.scrollLines(i),
        ...
        this.$computeLayerConfig = function() {
            ...
            l = t.scrollerHeight + e.getRowLength(w) * $ + f,
            m = this.scrollTop - g * $;
            var y = 0;
        ...
        this.scrollCursorIntoView = function(e, t, i) {
            if (0 !== this.$size.scrollerHeight) {
                ...
                o < l + r ? (t && l + r > o + this.lineHeight && (o -= t * this.$size.scrollerHeight),
                ...
                s < h ? (s < this.$padding + 2 * this.layerConfig.characterWidth && (s = -this.scrollMargin.left),
    ...
    t.onMouseDown = function(e) {
        ...
        e.editor.inMultiSelectMode && 2 == r)
            ...
            if (0 === r) {
                ...
                if (a && R.isMac && t.ctrlKey && l.$mouseHandler.cancelContextMenu(),
                "add" == a) {
                    if (!c && g)
                        return;
                    if (!c) {
                    ...
                    n && (b = null,
                    $ = h.ranges[0] || $,
                    l.removeSelectionMarker($)),
                    l.once("mouseup", function() {
                        var e = h.toOrientedRange();
                        b && e.isEmpty() && k(b.cursor, e.cursor) ? h.substractPoint(e.cursor) : (n ? h.substractPoint($.cursor) : $ && (l.removeSelectionMarker($),
                        h.addRange($)),
                        h.addRange(e)),
                    ...
                    function y() {
                        ...
                        k(w, e) && k(t, h.lead) || (w = e,
                        l.selection.moveToPosition(t),
                        l.renderer.scrollCursorIntoView(),
                        l.removeSelectionMarkers(C),
                        C = h.rectangularRangeBlock(w, v),
                        l.$mouseHandler.$clickSelection && 1 == C.length && C[0].isEmpty() && (C[0] = l.$mouseHandler.$clickSelection.clone()),
                        C.forEach(l.addSelectionMarker, l),
                        l.updateSelectionMarkers())
                    }
                    var S, C = [];
                    c && !o ? h.toSingleRange() : !c && o && (S = h.toOrientedRange(),
                    l.addSelectionMarker(S)),
                    n ? v = p.documentToScreenPosition(h.lead) : h.moveToPosition(u),
                    w = {
                        row: -1,
                        column: -1
                    };
                    ...
                    L.capture(l.container, function(e) {
                        ...
                        clearInterval(A),
                        l.removeSelectionMarkers(C),
                        C.length || (C = [h.toOrientedRange()]),
                        S && (l.removeSelectionMarker(S),
                        h.toSingleRange(S));
...
define("ace/multi_select", ["require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor", "ace/config"], function(e, t, i) {
        ...
        this.rectangularRangeBlock = function(e, t, i) {
            ...
            for (var m = g; m <= f; m++) {
                ...
                if (p.isEmpty()) {
                    if (h && (c = p.end,
                    u = h,
                    c.row == u.row && c.column == u.column))
                        break;
                    h = p.end
                }
                p.cursor = s ? p.start : p.end,
                n.push(p)
            }
            if (d && n.reverse(),
            !i) {
    ...
    (function() {
        ...
        this.$onMultiSelectExec = function(e) {
            ...
            if (i.multiSelect) {
                if (t.multiSelectAction)
                    n = "forEach" == t.multiSelectAction ? i.forEachSelection(t, e.args) : "forEachLine" == t.multiSelectAction ? i.forEachSelection(t, e.args, !0) : "single" == t.multiSelectAction ? (i.exitMultiSelectMode(),
                    t.exec(i, e.args || {})) : t.multiSelectAction(i, e.args || {});
                else {
        ...
        this.selectMore = function(e, t, i) {
            ...
            if (!s.isEmpty() || ((s = n.getWordRange(s.start.row, s.start.column)).cursor = -1 == e ? s.start : s.end,
            this.multiSelect.addRange(s),
            !i)) {
                var o, r, a, l = n.getTextRange(s), h = (o = n,
                r = l,
                a = e,
                c.$options.wrap = !0,
                c.$options.needle = r,
