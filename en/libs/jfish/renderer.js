var RENDERER = {
    ...
    render : function(){
        ...
        var col = this.context.createLinearGradient(0, 0, this.width, 0);
        col.addColorStop(0, '#87CEFA');
        col.addColorStop(1, '#6495ED');
        this.context.fillStyle = col; // 波浪的颜色
...
FISH.prototype = {
    ...
    render : function(context){
        ...
        context.scale(1 * per, this.direction ? 1 : -1);
        context.beginPath();
        context.moveTo(-30, 0);
        ...
        context.scale((0.9 + 0.2 * Math.sin(this.theta)) * per, 1);
        context.beginPath();
        context.moveTo(0, 0);
